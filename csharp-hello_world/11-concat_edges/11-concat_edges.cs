...
class Program
{
    static void Main(string[] args)
    {
        ...
        str = str.Substring(str.IndexOf('-') - 7, 15) + str[2] + str.Substring(str.IndexOf('p', str.IndexOf('-', str.IndexOf('-') + 1)), 11) + str[2] + str.Substring(str.IndexOf('i', str.IndexOf('.', str.IndexOf('p', str.IndexOf('-', str.IndexOf('-') + 1)))), 2) + str[2] + str.Substring(0, 2);
