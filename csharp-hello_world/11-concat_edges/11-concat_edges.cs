...
class Program
{
    static void Main(string[] args)
    {
        ...
        str = str.Substring(str.IndexOf('-') - 7, 15) + str[1] + str.Substring(str.IndexOf('p', str.IndexOf('-')), 11) + str[1] + str.Substring(str.IndexOf('i', str.IndexOf('.', str.IndexOf('p', str.IndexOf('-')))), 2) + str[1] + str.Substring(0, 2);
